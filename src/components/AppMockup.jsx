        ...
        <div className="relative hidden md:flex justify-center">
          ...
          <div className="relative w-full max-w-5xl">
            ...
            <div className="bg-gray-800 rounded-lg shadow-2xl p-3 overflow-hidden">
              ...
              <div className="bg-gray-100 rounded-b-lg overflow-hidden">
                ...
                <div className="bg-primary text-white p-4 flex items-center justify-between">
                  <div className="text-2xl font-bold">QuickScope</div>
                ...
                <div className="flex h-[500px]">
                  ...
                  <div className="w-2/3 p-6 relative overflow-hidden">
                    ...
                    {/* News Card 1 */}
                    <div
                      className="bg-white rounded-xl shadow-lg p-6 mb-4 transition-all duration-300 transform"
                      style={{
                    ...
                    >
                      <h3 className="text-xl font-bold mb-3">{mockContent[0].title}</h3>
                      <p className="text-gray-600 mb-4 text-lg">{mockContent[0].summary}</p>
                      <div className="bg-indigo-50 p-4 rounded-lg">
                        <p className="text-sm text-primary font-medium mb-1">Why it matters to you:</p>
                        <p className="text-gray-700">{mockContent[0].whyItMatters}</p>
                      </div>
                      
                      <div className="flex justify-between mt-6">
                        <button className="px-4 py-2 bg-gray-200 rounded-lg text-gray-700">Details</button>
                        <div className="flex space-x-2">
                    ...
                    >
                      <h3 className="text-xl font-bold mb-3">{mockContent[1].title}</h3>
                      <p className="text-gray-600 mb-4 text-lg">{mockContent[1].summary}</p>
                      <div className="bg-indigo-50 p-4 rounded-lg">
                        <p className="text-sm text-primary font-medium mb-1">Why it matters to you:</p>
                        <p className="text-gray-700">{mockContent[1].whyItMatters}</p>
                      </div>
                    ...
                    >
                      <h3 className="text-xl font-bold mb-3">{mockContent[2].title}</h3>
                      <p className="text-gray-600 mb-4 text-lg">{mockContent[2].summary}</p>
                      <div className="bg-indigo-50 p-4 rounded-lg">
                        <p className="text-sm text-primary font-medium mb-1">Why it matters to you:</p>
                        <p className="text-gray-700">{mockContent[2].whyItMatters}</p>
                      </div>
                      ...
                      {mockContent.map((_, index) => (
                        <div 
                          ...
                          className={`h-2 rounded-full transition-all duration-300 ${
                            activeCard === index ? 'w-10 bg-primary' : 'w-2 bg-gray-300'
                          }`}
                        ></div>
                      ))}
                    </div>
                  ...
                  <div className="w-1/3 bg-gray-50 p-6 border-l border-gray-200">
                    <h3 className="text-lg font-semibold mb-4 text-gray-700">Ask AI</h3>
                    ...
                    <div className="bg-white rounded-xl shadow-md p-4 mb-4">
                      <div className="flex items-start mb-3">
                        ...
                        <div>
                          <p className="font-medium text-gray-700">{mockContent[activeCard].question}</p>
                        </div>
                      </div>
                      <div className="pl-10 border-l-2 border-indigo-200 ml-4">
                        <p className="text-gray-600">{mockContent[activeCard].answer}</p>
                      </div>
                    </div>
            ...
            <div className="absolute -right-4 top-1/4 transform translate-x-full">
              <div className="bg-primary text-white px-4 py-2 rounded-lg shadow-lg relative">
                <div className="absolute left-0 top-1/2 transform -translate-x-full -translate-y-1/2 border-t-2 border-primary w-8"></div>
                <p className="font-medium">Ask what it means for you</p>
              </div>
            </div>
            
            <div className="absolute -left-4 top-1/3 transform -translate-x-full">
              <div className="bg-secondary text-white px-4 py-2 rounded-lg shadow-lg relative">
                <div className="absolute right-0 top-1/2 transform translate-x-full -translate-y-1/2 border-t-2 border-secondary w-8"></div>
            ...
            <div className="absolute -left-4 top-2/4 transform -translate-x-full">
              <div className="bg-indigo-700 text-white px-4 py-2 rounded-lg shadow-lg relative">
                <div className="absolute right-0 top-1/2 transform translate-x-full -translate-y-1/2 border-t-2 border-indigo-700 w-8"></div>
